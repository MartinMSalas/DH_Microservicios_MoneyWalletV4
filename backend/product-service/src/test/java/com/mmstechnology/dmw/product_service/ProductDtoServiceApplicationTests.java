package com.mmstechnology.dmw.product_service;
...
class ProductDtoServiceApplicationTests {
    ...
    @Test
    void testProductServiceHealthCheck() {
    ...
    @Test
    void testProductServiceEnvEndpoint() {
    ...
    @Test
    void testProductServiceRefreshEndpoint() {
